  ...
  return (
    <div className="flex flex-col mb-10 md:mt-0 md:mb-0">
      ...
      <div className="grid md:grid-cols-[1fr_2fr_1fr] grid-cols-1 gap-8 md:py-10">
        <div className="flex flex-col items-center justify-center gap-6 p-10 text-white border rounded-3xl bg-white/5">
          <h4>Demographics</h4>
        ...
        <div className="flex flex-col items-center justify-center gap-6 p-10 text-white border md:py-20 rounded-3xl bg-white/5">
