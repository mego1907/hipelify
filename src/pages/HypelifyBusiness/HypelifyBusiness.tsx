  ...
  return (
    <div className="flex flex-col pt-10 md:pt-32">
      <div className="flex flex-col text-center text-white md:h-[70vh] h-[80vh] items-center justify-center md:gap-0 gap-5">
        ...
        <CustomButton className="md:p-6 md:mt-10 md:px-6">
      ...
      <div className="flex items-center justify-center md:py-40">
        <CustomButton className="md:text-[1.7rem] md:p-4 md:px-8 md:mt-0 mt-10">
          <span>Ready. Set. Launch</span>
        </CustomButton>
      </div>
